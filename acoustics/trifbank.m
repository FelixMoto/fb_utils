...
%
%           H2W (optional) is a Hertz scale to warped scale function handle
%
%           W2H (optional) is a warped scale to Hertz scale function handle
%
%   Outputs
...
% warping function handles
if nargin < 5 || isempty(h2w)
    h2w = @(hz)(1127*log(1+hz/700)); 
end
if nargin < 6 || isempty(w2h)
    w2h = @(mel)(700*exp(mel/1127)-700);
end

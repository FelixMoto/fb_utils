function out = plotBarStackGroups(stackData, groupLabels)
...
% accepts FaceColor for bars as varargin. matrix with RGB triplets must be
% size of handles
% RGB triplets must be in first dimension
